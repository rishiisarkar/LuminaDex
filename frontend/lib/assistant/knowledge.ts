...
export const luminaKnowledge: Record<string, AssistantAnswer> = {
  wallet: {
    ...
    body: "Use Connect Wallet to link your Stellar wallet. LuminaDex never asks for your seed phrase, private key, or wallet password.",
    steps: [
      "Click Connect Wallet in the navigation.",
      "Choose Freighter or another supported Stellar wallet.",
      "Approve the connection in your wallet.",
      "Review the shortened address shown in LuminaDex.",
    ],
  },
  swap: {
    title: "How to swap XLM and USDC",
    body: "Swap lets you exchange supported Stellar assets using LuminaDex liquidity pools. Always review the quote before confirming.",
    steps: [
  ...
  feeTier: {
    title: "Fee tier",
    body: "The fee tier is the percentage of each trade paid to liquidity providers in that pool. LuminaDex shows the pool fee before you provide liquidity.",
  },
  priceRange: {
    title: "Price range",
  ...
  transactions: {
    ...
    body: "LuminaDex builds the transaction, asks your wallet for approval, submits it to Stellar, and waits for confirmation. If it fails, review the message and try again after fixing the issue.",
  },
  usdc: {
    title: "Getting USDC",
    body: "USDC is a Stellar asset. On Testnet, you may need a trustline and test assets. LuminaDex will warn you if your wallet cannot receive or spend the asset yet.",
  },
  outOfRange: {
    title: "Out of range",
  ...
  financialAdvice: {
    ...
    body: "I can explain how LuminaDex works, but the decision to trade or provide liquidity is yours. I cannot tell you what to buy or whether a price is good.",
  },
  security: {
    title: "Wallet safety",
    body: "For your security, never share your wallet seed phrase, private key, password, or recovery phrase. LuminaDex will never ask you for them.",
  },
};
...
export function getPageExplanation(pathname: string): AssistantAnswer {
  if (pathname.startsWith("/swap")) {
    return {
      ...
      body: "This page lets you exchange supported Stellar assets using LuminaDex liquidity pools. Select what you pay with, enter an amount, review the quote and slippage, then confirm in your Stellar wallet.",
  ...
  return {
    title: "This LuminaDex page",
    body: "LuminaDex helps you swap XLM and USDC, provide concentrated liquidity, and track positions on Stellar.",
  };
}
