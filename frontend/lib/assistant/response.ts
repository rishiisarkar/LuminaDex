...
export async function getAssistantResponse(
  ...
  if (!normalized) {
    return {
      title: "Ask Lumina",
      body: "Ask me about Swap, Liquidity, Portfolio, wallet connection, or DeFi terms shown in LuminaDex.",
    };
  }
  ...
  return {
    title: "LuminaDex help",
    body: "I can help with LuminaDex features, swaps, liquidity, portfolio tracking, wallet connection, and common DeFi terms. Try asking: “What is slippage?” or “How do I add liquidity?”",
  };
}
