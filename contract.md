...
Reorganized the `contracts/` directory as a Cargo workspace with all contracts as members. Compilations and optimizations were performed, followed by fresh deployments using the `rishii` account on Stellar Testnet:
